...
- **墨 / 沙**：底部左侧的分段钮。切到「沙」会换成六枚材料圆点（墨的五个色点同时隐藏），物理模拟从
...
- **材料**：沙 / 水 / 石 / 尘 / 墨 / 雾。
  ...
  - **反应规则（像粉末游戏那样“物质会互相作用”）**：沙 / 尘 碰到水会变“湿”——
    湿沙堆在水面上也不沉、能堆出沙丘沙堡；雾贴着石头或水面会慢慢凝成水珠（露），
    给雾一个安静的归处。都是安静的、不爆炸的互动。
